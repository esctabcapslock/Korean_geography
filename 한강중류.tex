...
우리가 갈 곳은 신륵사 옆에 위치한 여주 도자세상이다.
 ...
 \footnotetext{반달미술관 내부 모습, \href{https://www.kocef.org/02museum/2021_04.asp}{한국도자제단 $>$ 강신봉 제6달항아리전 갈무리}}
 \begin{figure}
    \centering
    ...
    \label{fig:my_labe3}
\end{figure}
\footnotetext{여주도자세상 전경, \href{http://www.yjceramic.or.kr/2020/main/main.html}{제 32회 여주도자기축제 누리집 갈무리}}
...
\begin{figure}
    ...
    \caption{집중호우 시에 수문을 개방한 팔당댐 \protect\footnotemark}
    \label{fig:my_labe9}
\end{figure}
